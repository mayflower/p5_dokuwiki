    ...
    if ($evt->advise_before()){
        ...
        $menu = array_merge($menu, array(
           ...
           array(
                ...
                'title'  => $lang['qb_media'],
                'icon'   => 'image.png',
                'url'    => DOKU_BASE.basename(DOKU_INC).'/'.'lib/exe/mediamanager.php?ns=',
                'name'   => 'mediaselect',
